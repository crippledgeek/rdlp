...
class TestDispatchUrl:
    ...
    def test_sibling_override_primary_wins(self):
        ...
        cls = dispatch_url(
            [_SiblingSeriesIE, _SiblingPrimaryIE],
            url,
        )
    ...
    def test_dispatch_order_independent(self):
        ...
        # Reverse the list
        cls = dispatch_url(
            [_SiblingPrimaryIE, _SiblingSeriesIE],
            url,
        )
        assert cls is _SiblingPrimaryIE
    ...
    def test_buggy_suitable_logs_via_host(self, monkeypatch):
        ...
        assert any(level == 'warn' and '_BrokenIE2' in msg and 'boom' in msg for level, msg in logged), (
