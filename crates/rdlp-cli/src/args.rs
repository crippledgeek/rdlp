...
use crate::args_help::{
    ...
    HELP_LOUDNORM_TP, HELP_NORMALIZE_BOOST, HELP_NORMALIZE_BOOST_DB,
};
...
/// `value_parser` for `--loudnorm-preset`.
///
/// Parses at the boundary through [`LoudnormPreset`]'s own `FromStr` — the
