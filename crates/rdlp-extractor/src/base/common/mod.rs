...
pub(crate) use search::{
    ...
    append_search_filters, filter_value, first_resolvable_media_attr, format_std_filter_error,
    is_not_a_data_uri, resolve_card_url, resolve_media_url, validate_against_descriptors,
};
