...
impl TnaFlixNetworkBase {
    ...
    fn extract_json_ld(&self, html: &Html) -> Option<JsonLdVideo> {
    ...
    fn extract_view_count(&self, json_ld: &JsonLdVideo) -> Option<u64> {
    ...
    fn extract_tags(&self, json_ld: &JsonLdVideo) -> Option<Vec<String>> {
    ...
    fn extract_categories(&self, json_ld: &JsonLdVideo) -> Option<Vec<String>> {
    ...
    fn extract_thumbnails(&self, json_ld: &JsonLdVideo) -> Option<Vec<rdlp_core::Thumbnail>> {
