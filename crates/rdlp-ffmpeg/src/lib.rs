...
pub use ffmpeg::{
    ...
    default_codec_for_container, encoding_tool_tag, known_undeclared_support, muxer_can_represent,
    resolve_recode_encoder, set_verbose, supports_thumbnail_embed, uses_native_attachment,
