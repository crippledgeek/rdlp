...
interface SettingsOutputSectionProps {
    draft: AppSettings;
    onChange: (next: AppSettings) => void;
    onPickDir: () => void;
}

export const SettingsOutputSection = memo(function SettingsOutputSection({
    draft,
    onChange,
    onPickDir,
}: SettingsOutputSectionProps) {
    return (
        <>
            <div className="mb-4">
                ...
                <div className="flex gap-1.5">
                    ...
                    <Button variant="outline" onClick={onPickDir}>Browse</Button>
                </div>
            </div>
