...
interface SettingsNormalizationSectionProps {
    draft: AppSettings;
    onChange: (next: AppSettings) => void;
}

export const SettingsNormalizationSection = memo(function SettingsNormalizationSection({
    draft,
    onChange,
}: SettingsNormalizationSectionProps) {
    return (
        <>
            <h3
                ...
                <div className="settings-toggle-row mb-3">
                    <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                            onChange({ ...draft, normalize_audio: checked === true })
                        }
                    />
                    ...
                    <CollapsibleContent className="pl-4 border-l-2 border-border space-y-3 overflow-hidden">
                        ...
                        <div>
                            ...
                            <TooltipProvider>
                                <ToggleGroup
                                    ...
                                    onValueChange={(val) => {
                                        if (val) onChange({ ...draft, loudnorm: val === "loudnorm" });
                                    }}
                            ...
                            <>
                                ...
                                <div className="settings-toggle-row">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) =>
                                            onChange({ ...draft, loudnorm_dynamic: checked === true })
                                        }
                                    />
                                    <Label
                                ...
                                <div className="settings-toggle-row">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) =>
                                            onChange({ ...draft, loudnorm_precompress: checked === true })
                                        }
                                    />
                                    <Label
                        ...
                        <div className="settings-toggle-row">
                            <Checkbox
                                ...
                                onCheckedChange={(checked) =>
                                    onChange({ ...draft, normalize_boost: checked === true })
                                }
                            />
                            <Label
