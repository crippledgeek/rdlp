...
export function SettingsPage() {
    ...
    return (
        <div className="max-w-2xl pb-6">
            <h2 className="text-lg font-bold mb-5 text-foreground tracking-tight">Settings</h2>
            ...
            {/* ── Cookies ───────────────────────────────────────── */}
            <section className="settings-panel" aria-labelledby="cookies-heading">
                <h3 id="cookies-heading" className="settings-panel-title">
            ...
            {/* ── Network ───────────────────────────────────────── */}
            <section className="settings-panel" aria-labelledby="network-heading">
                <h3 id="network-heading" className="settings-panel-title">
